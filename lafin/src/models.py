...
class BaseModel(nn.Module):
    ...
    def load_generator(self):
        if os.path.exists(self.gen_weights_path):
            print('Loading %s generator to convert it to tf2 ...' % self.name)
            ...
            # del data['generator']['auto_attn.gamma']
            # del data['generator']['auto_attn.alpha']
            # del data['generator']['auto_attn.query_conv.weight']
            # del data['generator']['auto_attn.query_conv.bias']
            # del data['generator']['auto_attn.model.conv1.bias']
            # del data['generator']['auto_attn.model.conv1.weight_orig']
            # del data['generator']['auto_attn.model.conv1.weight_u']
            # del data['generator']['auto_attn.model.conv1.weight_v']
            # del data['generator']['auto_attn.model.conv2.bias']
            # del data['generator']['auto_attn.model.conv2.weight_orig']
            # del data['generator']['auto_attn.model.conv2.weight_u']
            # del data['generator']['auto_attn.model.conv2.weight_v']
            # del data['generator']['auto_attn.model.bypass.bias']
            # del data['generator']['auto_attn.model.bypass.weight_orig']
            # del data['generator']['auto_attn.model.bypass.weight_u']
            # del data['generator']['auto_attn.model.bypass.weight_v']
            # del data['generator']['auto_attn.model.model.1.bias']
            # del data['generator']['auto_attn.model.model.1.weight_orig']
            # del data['generator']['auto_attn.model.model.1.weight_u']
            # del data['generator']['auto_attn.model.model.1.weight_v']
            # del data['generator']['auto_attn.model.model.3.bias']
            # del data['generator']['auto_attn.model.model.3.weight_orig']
            # del data['generator']['auto_attn.model.model.3.weight_u']
            # del data['generator']['auto_attn.model.model.3.weight_v']
            # del data['generator']['auto_attn.model.shortcut.0.bias']
            # del data['generator']['auto_attn.model.shortcut.0.weight_orig']
            # del data['generator']['auto_attn.model.shortcut.0.weight_u']
            # del data['generator']['auto_attn.model.shortcut.0.weight_v']
